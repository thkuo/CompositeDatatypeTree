...
# +++++
# Core functions
def make_alf_config(config_template, project_name,
                    genome_db_f, tree_f, output_dir):
...
parser = argparse.ArgumentParser(
    description='Simulate coding regions using ALF')
...
alf_config_file = make_alf_config(config_template, project_name,
                                  genome_db_f, tree_f, output_dir)
# run alf
