...
source('load_mlst.R')
tr_files<- list('nuc'= '~/bifo-sgi/TreePaper/Paeru.v4/results.4/raxml/RAxML_bipartitions.nuc.bs', 
                'cd75'= '~/personal-backup/Paeru.v4/results.5//cd_cutoff75/RAxML_bipartitions.conc.bs')
