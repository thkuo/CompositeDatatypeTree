...
parser.add_argument('--nuc_aln', type=str, dest= 'in_n',
        required= True)
parser.add_argument('--gpa_aln', type=str, dest= 'in_g',
        required= True)
parser.add_argument('--out_aln', type=str, dest= 'out_aln',
        required= True)
parser.add_argument('--out_prtn', type=str, dest= 'out_prtn',
        required= True)

args = parser.parse_args()
n_aln= AlignIO.read(args.in_n, 'fasta')
g_aln= AlignIO.read(args.in_g, 'fasta')
...
AlignIO.write(conc_aln, args.out_aln, 'fasta')
# print the partitions
with open(args.out_prtn, 'w') as out_fh:
